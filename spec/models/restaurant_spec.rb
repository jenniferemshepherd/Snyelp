...
RSpec.describe Restaurant, :type => :model do
  it "creates a restaurant with a name and description" do
    ...
    expect(restaurant.name).to eq "Psycho Bob's Chicken Shack"
    expect(restaurant.description).to eq "Psychadelic freak out joint with live music from Psycho Bob"
  end
